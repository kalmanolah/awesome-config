...
globalkeys = awful.util.table.join(
    ...
    -- Lock screen
    --awful.key({ vars.modkey, "Control" }, "l", function() awful.util.spawn("xscreensaver-command --lock") end ),

    -- Reconfigure amount of screens using disper
    awful.key({ vars.modkey }, "Escape", function() awful.util.spawn("disper -e") end)
