...
--
-- IMPORTANT: Modified to have ror.genkeys accept a "table" argument instead of requiring a ror.lua file.
...
function aweror.genkeys(modkey, table)
    rorkeys = awful.util.table.join()

    for i,v in pairs(table) do
        rorkeys = awful.util.table.join(rorkeys, awful.key({ modkey }, i, genfun(v)))
    end
